...
export default function AudioPlayer({ audioSrc, title, isDarkMode }: AudioPlayerProps) {
  ...
  return (
    <div className={`mb-6 max-w-md mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
      <div className={`${isDarkMode ? 'bg-gray-800/50 border-gray-600/30' : 'bg-white/80 border-gray-200/50'} p-4 rounded-xl border backdrop-blur-sm shadow-lg`}>
        {/* Title */}
